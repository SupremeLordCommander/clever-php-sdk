...
```php
getContactsForUser($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\UsersResponse
```
...
```php
getDistrictForUser($id): \OpenAPI\Client\Model\DistrictResponse
```
...
```php
getResourcesForUser($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\ResourcesResponse
```
...
```php
getSchoolsForUser($id, $primary, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\SchoolsResponse
```
...
```php
getSectionsForUser($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\SectionsResponse
```
...
```php
getStudentsForUser($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\UsersResponse
```
...
```php
getTeachersForUser($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\UsersResponse
```
...
```php
getUsers($limit, $role, $starting_after, $ending_before, $count): \OpenAPI\Client\Model\UsersResponse
```
