...
------------- | ------------- | -------------
[**getCoursesForResource()**](ResourcesApi.md#getCoursesForResource) | **GET** /resources/{id}/courses | 
[**getResource()**](ResourcesApi.md#getResource) | **GET** /resources/{id} | 
[**getResources()**](ResourcesApi.md#getResources) | **GET** /resources | 
[**getSectionsForResource()**](ResourcesApi.md#getSectionsForResource) | **GET** /resources/{id}/sections | 
[**getUsersForResource()**](ResourcesApi.md#getUsersForResource) | **GET** /resources/{id}/users | 


## `getCoursesForResource()`

```php
getCoursesForResource($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\CoursesResponse
```
...
try {
    ...
    echo 'Exception when calling ResourcesApi->getCoursesForResource: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\CoursesResponse**](../Model/CoursesResponse.md)
...
```php
getResource($id): \OpenAPI\Client\Model\ResourceResponse
```
...
[**\OpenAPI\Client\Model\ResourceResponse**](../Model/ResourceResponse.md)
...
```php
getResources($limit, $starting_after, $ending_before): \OpenAPI\Client\Model\ResourcesResponse
```
...
```php
getSectionsForResource($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\SectionsResponse
```
...
try {
    ...
    echo 'Exception when calling ResourcesApi->getSectionsForResource: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getUsersForResource($id, $role, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\UsersResponse
```
...
try {
    ...
    echo 'Exception when calling ResourcesApi->getUsersForResource: ', $e->getMessage(), PHP_EOL;
}
```
