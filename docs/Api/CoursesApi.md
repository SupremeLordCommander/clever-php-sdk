...
```php
getCourse($id): \OpenAPI\Client\Model\CourseResponse
```
...
```php
getCourses($limit, $starting_after, $ending_before, $count): \OpenAPI\Client\Model\CoursesResponse
```
...
```php
getDistrictForCourse($id): \OpenAPI\Client\Model\DistrictResponse
```
...
```php
getResourcesForCourse($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\ResourcesResponse
```
...
```php
getSchoolsForCourse($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\SchoolsResponse
```
...
```php
getSectionsForCourse($id, $limit, $starting_after, $ending_before): \OpenAPI\Client\Model\SectionsResponse
```
