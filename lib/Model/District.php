...
class District implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'district_contact' => '\OpenAPI\Client\Model\DistrictContact',
        'error' => 'string',
        'id' => 'string',
        'last_sync' => 'string',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\DistrictContact|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DistrictContact|null $district_contact district_contact
     *
     * @return self
     */
