...
class Roles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'district_admin' => '\OpenAPI\Client\Model\DistrictAdmin',
        'staff' => '\OpenAPI\Client\Model\Staff',
        'student' => '\OpenAPI\Client\Model\Student',
        'teacher' => '\OpenAPI\Client\Model\Teacher'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('district_admin', $data ?? [], null);
    ...
    */
     ...
     * Gets district_admin
     *
     * @return \OpenAPI\Client\Model\DistrictAdmin|null
     */
     ...
     * Sets district_admin
     *
     * @param \OpenAPI\Client\Model\DistrictAdmin|null $district_admin district_admin
     *
     * @return self
     */
    public function setDistrictAdmin($district_admin)
    {
        ...
        if (is_null($district_admin)) {
            throw new \InvalidArgumentException('non-nullable district_admin cannot be null');
        }
     ...
     * Gets student
     *
     * @return \OpenAPI\Client\Model\Student|null
     */
     ...
     * Sets student
     *
     * @param \OpenAPI\Client\Model\Student|null $student student
     *
     * @return self
     */
     ...
     * Gets teacher
     *
     * @return \OpenAPI\Client\Model\Teacher|null
     */
     ...
     * Sets teacher
     *
     * @param \OpenAPI\Client\Model\Teacher|null $teacher teacher
     *
     * @return self
     */
    public function setTeacher($teacher)
    {
        ...
        if (is_null($teacher)) {
            throw new \InvalidArgumentException('non-nullable teacher cannot be null');
        }
