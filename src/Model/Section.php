...
class Section implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sectionNumber'] = isset($data['sectionNumber']) ? $data['sectionNumber'] : null;
    ...
    {
        return $this->container['sectionNumber'];
    }

    /**
     * Sets sectionNumber
     *
     * @param string $sectionNumber sectionNumber
     *
     * @return $this
     */
    public function setSectionNumber($sectionNumber)
    {
        $this->container['sectionNumber'] = $sectionNumber;
