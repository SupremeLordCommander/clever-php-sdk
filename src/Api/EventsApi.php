...
class EventsApi
{
     ...
     * @param  string[] $recordType recordType (optional)
     *
     * @throws \Clever\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Clever\Client\Model\EventsResponse
     */
    public function getEvents($limit = null, $startingAfter = null, $endingBefore = null, $school = null, $recordType = null)
    {
        list($response) = $this->getEventsWithHttpInfo($limit, $startingAfter, $endingBefore, $school, $recordType);
        return $response;
    }
     ...
     * @param  string[] $recordType (optional)
     *
     * @throws \Clever\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Clever\Client\Model\EventsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEventsWithHttpInfo($limit = null, $startingAfter = null, $endingBefore = null, $school = null, $recordType = null)
    {
        $returnType = '\Clever\Client\Model\EventsResponse';
        $request = $this->getEventsRequest($limit, $startingAfter, $endingBefore, $school, $recordType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventsAsync($limit = null, $startingAfter = null, $endingBefore = null, $school = null, $recordType = null)
    {
        return $this->getEventsAsyncWithHttpInfo($limit, $startingAfter, $endingBefore, $school, $recordType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventsAsyncWithHttpInfo($limit = null, $startingAfter = null, $endingBefore = null, $school = null, $recordType = null)
    {
        $returnType = '\Clever\Client\Model\EventsResponse';
        $request = $this->getEventsRequest($limit, $startingAfter, $endingBefore, $school, $recordType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEventsRequest($limit = null, $startingAfter = null, $endingBefore = null, $school = null, $recordType = null)
    {
        ...
        if ($recordType !== null) {
            $queryParams['record_type'] = ObjectSerializer::toQueryValue($recordType);
        }
